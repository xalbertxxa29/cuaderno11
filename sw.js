/* sw.js (v62)
   ...
   - No intercepta métodos ≠ GET. Evita terceros (cross-origin), Firebase/Google y CDNs.
...
/* ==== Precarga local (ajusta si cambias rutas) ==== */
const PRECACHE_URLS = [
  // Páginas principales
  './',
  './index.html',
...
self.addEventListener('fetch', (event) => {
  ...
  // *** NUEVO: evita cualquier origen cruzado (CDNs, APIs externas) ***
  if (url.origin !== self.location.origin) return;

  // Dejar pasar también Firebase/Google si estuvieran en mismo origen (defensivo)
